  ...
  return (
    <section className="v3-about" aria-labelledby="about-title">
      ...
      <div className="v3-about-card">
        ...
        <img className="v3-about-rabbit" src="/garden-assets/animals/rabbit.svg" alt="" aria-hidden="true" />
        <div className="v3-about-copy">
          <p>一个安静的人，喜欢记录生活，<br />热爱自然，持续成长中。</p>
          <Link href="/about">了解更多 →</Link>
        </div>
        <img className="v3-about-cat" src="/garden-assets/animals/cat.svg" alt="" aria-hidden="true" />
      </div>
    </section>
  );
}
