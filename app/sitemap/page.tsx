...
export const metadata: Metadata = {
  title: "网站地图 | LMN516",
  description: "浏览 LMN516 的文章、照片、音乐、碎碎念与其他生活档案。",
};
    ...
    groups: [
      {
        ...
        links: [
          { label: "本期", href: "/#notes" },
          { label: "专题", href: "/#project" },
          { label: "收藏", href: "/#archive" },
          { label: "关于", href: "/#about" },
        ],
      },
      {
    ...
    <>
      ...
      <main className="sitemap-page shell">
        <header className="sitemap-hero">
          <p className="eyebrow">LMN516 DIRECTORY</p>
          <h1>网站地图</h1>
          <p>这里收录了目前开放的页面。沿着目录走，可以找到这座数字花园里已经长出来的内容。</p>
        </header>
